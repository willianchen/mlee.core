...
namespace mlee.Core.Library.Helpers
{
    ...
    public static partial class Convert
    {
        ...
        public static int ToInt(object input, int defaultVal = 0)
        {
            return ToIntOrNull(input) ?? defaultVal;
        }
        ...
        /// </summary>
        /// <param name="input">输入值</param>
        public static long ToLong(object input, long defaultVal = 0)
        {
            return ToLongOrNull(input) ?? defaultVal;
        }
        ...
        public static float ToFloat(object input, int? digits = null, float defaultVal = 0)
        {
            return ToFloatOrNull(input, digits) ?? defaultVal;
        }
        ...
        /// <param name="input">输入值</param>
        /// <param name="digits">小数位数</param>
        public static double ToDouble(object input, int? digits = null, double defaultVal = 0)
        {
            return ToDoubleOrNull(input, digits) ?? defaultVal;
        }
        ...
        /// <param name="input">输入值</param>
        /// <param name="digits">小数位数</param>
        public static decimal ToDecimal(object input, int? digits = null, decimal defaultVal = 0)
        {
            return ToDecimalOrNull(input, digits) ?? defaultVal;
        }
        ...
        /// </summary>
        /// <param name="input">输入值</param>
        public static bool ToBool(object input, bool defaultVal = false)
        {
            return ToBoolOrNull(input) ?? defaultVal;
        }
