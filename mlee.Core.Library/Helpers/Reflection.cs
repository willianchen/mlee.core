...
namespace mlee.Core.Library.Helpers
{
    ...
    public static partial class Reflection
    {
        ...
        /// <summary>
        /// 获取类型成员描述，使用NoteAttribute设置描述
        /// </summary>
        /// <typeparam name="T">类型</typeparam>
        /// <param name="memberName">成员名称</param>
        public static string GetNote<T>(string memberName)
        {
            return GetNote(Common.GetType<T>(), memberName);
        }
        ...
        /// <param name="type">类型</param>
        /// <param name="memberName">成员名称</param>
        public static string GetNote(Type type, string memberName)
        {
            if (type == null)
                return string.Empty;
            if (string.IsNullOrWhiteSpace(memberName))
                return string.Empty;
            return GetNote(type.GetTypeInfo().GetMember(memberName).FirstOrDefault());
        }
        ...
        /// <returns></returns>
        public static string GetNote(MemberInfo member)
        {
            if (member == null)
                return string.Empty;
            return member.GetCustomAttribute<NoteAttribute>() is NoteAttribute attribute ? attribute.Note : string.Empty;
        }
        ...
        public static System.Type GetTypeByName(string typeName)
        {
            ...
            var finder = new mlee.Core.Library.Reflections.Finder();
            Assembly[] assemblyArray = finder?.GetAssemblies().ToArray();
        ...
        public static List<PropertyInfo> GetPublicPropertyList(object instance)
        {
        ...
        /// </summary>
        /// <param name="instance">实例</param>
        public static List<Item> GetPublicPropertiesAndDes(object instance)
        {
            return GetPublicPropertiesAndDesFromType(instance.GetType(), instance);
        }
        ...
        /// <returns></returns>
        public static List<Item> GetPublicPropertiesAndDesFromType(Type type, object instance)
        {
            var properties = type.GetProperties();
            return properties.ToList().Select(t => new Item(GetDisplayNameOrDescription(t), t.GetValue(instance), t.Name)).ToList();
        }
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public static List<Item> GetPublicPropertiesAndDesFromType(Type type)
        {
            var properties = type.GetProperties();
            return properties.ToList().Select(t => new Item(GetDisplayNameOrDescription(t), t.Name)).ToList();
        }
