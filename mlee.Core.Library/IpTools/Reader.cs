    ...
    public class Reader
    {
        ...
        public Reader(string name)
        {
            if (data == null)
            {
                ...
                var meta2 = JsonConvert.DeserializeObject<MetaData>(Encoding.UTF8.GetString(metaBytes));

                nodeCount = meta2.nodeCount;
                meta = meta2;

                if ((meta2.totalSize + (int)metaLength + 4) != data.Length)
                {
