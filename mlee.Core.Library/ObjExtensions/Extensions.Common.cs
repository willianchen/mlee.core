...
namespace mlee.Core.Library
{
    ...
    public static partial class Extensions
    {
        ...
        /// <summary>
        /// 获取枚举Note,使用System.ComponentModel.Description特性设置描述
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static string Note(this System.Enum instance)
        {
            if (instance == null)
                return string.Empty;
            return Helpers.Enum.GetNote(instance.GetType(), instance);
        }

        /// <summary>
        /// 获取枚举Note 如空获取Description
        /// </summary>
        /// <param name="instance"></param>
        /// <returns></returns>
        public static string NoteThenDes(this System.Enum instance)
        {
            var result = instance.Note();
            return !string.IsNullOrEmpty(result) ? result : instance.Description();
        }
