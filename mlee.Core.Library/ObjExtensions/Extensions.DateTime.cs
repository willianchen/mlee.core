...
namespace mlee.Core.Library
{
    ...
    public static partial class Extensions
    {
        ...
        /// <returns></returns>
        public static long ToTimeStamp(this DateTime obj, bool isUtc = false)
        {
            return CustomHelper.GetTimeStamp(obj, isUtc);
        }
        ...
        /// <param name="isUtc"></param>
        /// <returns></returns>
        public static DateTime ToDateTime(this long obj, bool isUtc = false)
        {
            return CustomHelper.GetDateTimeByTimeStamp(obj, isUtc);
        }
        /// <summary>
        /// 转换为秒级时间戳
        /// </summary>
        ...
        /// <param name="isUtc"></param>
        /// <returns></returns>
        public static long ToMillisecondTimeStamp(this DateTime obj, bool isUtc = false)
        {
            return CustomHelper.GetMillisecondTimeStamp(obj, isUtc);
        }
        ...
        /// <param name="isUtc"></param>
        /// <returns></returns>
        public static DateTime ToDateTimeByMillisecondsTimeStamp(this long obj, bool isUtc = false)
        {
            return CustomHelper.GetDateTimeByMillisecondsTimeStamp(obj, isUtc);
        }
