...
namespace mlee.Core.Library.Webs.Clients
{
    ...
    public interface IRequest<out TRequest> where TRequest : IRequest<TRequest>
    {
        ...
        /// <returns></returns>
        TRequest SetHuntNetAuth(string appName, string appSecret);
        ...
        /// <returns></returns>
        TRequest SetBasicAuth(string userName, string pwd);
