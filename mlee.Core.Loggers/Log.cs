...
namespace mlee.Core.Loggers
{
    ...
    public class Log : LogBase<LogContent>
    {
        ...
        protected override void Init(LogContent content)
        {
            ...
            content.Operator = Session.UserName;
            content.Role = Session.RoleName;
        }
        ...
        private static ILogProviderFactory GetLogProviderFactory()
        {
            ...
            {
                return new NLogger.LogProviderFactory();
            }
        }
        ...
        private static ILogFormat GetLogFormat()
        {
            ...
            {
                return Format.ContentFormat.Instance;
            }
        }
        ...
        private static ISession GetSession()
        {
            ...
            {
                throw new Exception("No Session Implement");
