...
using mlee.Core.DynamicApi.Enums;
using System;
...
using mlee.Core.DynamicApi.Extensions;
using StackExchange.Profiling.Internal;
using mlee.Core.DynamicApi.Helpers;
    ...
    public class DynamicApiConvention : IApplicationModelConvention
    {
        ...
        public void Apply(ApplicationModel application)
        {
            foreach (var controller in application.Controllers)
            {
                ...
                var DynamicApiAttr = Reflection.GetSingleAttributeOrDefaultByFullSearch<DynamicApiAttribute>(type.GetTypeInfo());
        ...
        {
            if (controller.ApiExplorer.GroupName.IsNullOrWhiteSpace())
            {
        ...
        {
            bool isExist = false;
            var noMapMethod = Reflection.GetSingleAttributeOrDefault<NonDynamicMethodAttribute>(action.ActionMethod);
        ...
        private void ConfigureSelector(string areaName, string controllerName, ActionModel action)
        {
            ...
            var nonAttr = Reflection.GetSingleAttributeOrDefault<NonDynamicApiAttribute>(action.ActionMethod);
